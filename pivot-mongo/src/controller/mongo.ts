...
const username = 'YOUR MONGO CLOUD USERNAME';
const password = 'YOUR PASSWORD';
const db_name = 'DATABASE NAME';
const connection_string = 'mongodb+srv://'+username+':'+password+'@reportingdata.745pj.mongodb.net/'+db_name+'?retryWrites=true&w=majority';
