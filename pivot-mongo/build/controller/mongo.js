...
mongodb_1.MongoClient.connect('mongodb+srv://j9sh:vLIe1tCUixYrjKtq@reportingdata.745pj.mongodb.net/ReportingData?retryWrites=true&w=majority', {
    useNewUrlParser: true
}, (err, db) => {
    if (err)
        throw err;
    dbo = db.db("ReportingData");
